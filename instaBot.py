...
import pandas as pd
chromedriver_path = 'C:/Users/ruanc/Downloads/chromedriver.exe' # Change this to your own chromedriver path!
...
username.send_keys('evoautomacoes')
password = webdriver.find_element_by_name('password')
password.send_keys('035173')
...
hashtag_list = ['Postos', 'conveniencia', 'automções']
